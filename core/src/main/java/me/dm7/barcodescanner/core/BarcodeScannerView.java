...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    protected boolean mIsLaserEnabled = true;
    @ColorInt protected int mLaserColor = getResources().getColor(R.color.viewfinder_laser);
    @ColorInt protected int mBorderColor = getResources().getColor(R.color.viewfinder_border);
    protected int mMaskColor = getResources().getColor(R.color.viewfinder_mask);
    protected int mBorderWidth = getResources().getInteger(R.integer.viewfinder_border_width);
    protected int mBorderLength = getResources().getInteger(R.integer.viewfinder_border_length);
    protected boolean mRoundedCorner = false;
    protected int mCornerRadius = 0;
    protected boolean mSquaredFinder = false;
    private float mBorderAlpha = 1.0f;
    protected int mViewFinderOffset = 0;
